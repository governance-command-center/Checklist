...
function renderUserChecklist() {
  ...
  entries.forEach((e, i) => {
    ...
    html += `<th colspan="5" style="text-align:center;border-left:2px solid rgba(255,255,255,0.18)">
  ...
  entries.forEach((e, i) => {
    ...
    html += `
    <th class="sub-head d5-col" style="${borderStyle};background:rgba(37,99,235,0.35);" colspan="2">
      <span class="th-inner" style="padding:5px 10px;display:block;text-align:center;">
        <span style="font-size:12px;font-weight:700;color:#93C5FD;letter-spacing:.05em;">D-5</span>
        <span style="display:block;font-size:10px;color:rgba(147,197,253,0.7);font-weight:400;margin-top:1px;">status &amp; notes</span>
      </span>
    </th>
    <th class="sub-head d1-col" style="background:rgba(124,58,237,0.35);" colspan="2">
      <span class="th-inner" style="padding:5px 10px;display:block;text-align:center;">
        <span style="font-size:12px;font-weight:700;color:#C4B5FD;letter-spacing:.05em;">D-1</span>
        <span style="display:block;font-size:10px;color:rgba(196,181,253,0.7);font-weight:400;margin-top:1px;">status &amp; notes</span>
      </span>
    </th>
    <th class="sub-head" style="background:rgba(255,255,255,0.06);width:32px;"></th>`;
  });
  html += `</tr></thead>`;
  ...
  CHECKLIST_SECTIONS.forEach(sec => {
    ...
    html += `<tr class="cat-header">
      ...
      ${Array(entryCount * 5 + 1).fill('<td></td>').join('')}
    </tr>`;
    ...
    sec.items.forEach(item => {
      ...
      entries.forEach((_, ei) => {
        ...
        <td style="background:rgba(255,255,255,0.02);width:32px;"></td>`;
      });
